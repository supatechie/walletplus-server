...
exports.validateUserInput = [
    express_validator_1.body('firstName').trim().not().isEmpty().withMessage('name is required'),
    express_validator_1.body('lastName').trim().not().isEmpty().withMessage('name is required'),
